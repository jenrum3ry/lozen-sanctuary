...
export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="space-y-6 text-[#f0ece4]/80 leading-relaxed text-base md:text-lg mb-20">
        <p className="text-[#f0ece4] text-xl md:text-2xl font-medium leading-relaxed border-l-4 border-[#7b5ea7] pl-6 italic">
      ...
      {/* The Dream */}
      <div className="rounded-2xl p-8 md:p-10 bg-[#13101c] border border-[#7b5ea7]/30 mb-20 glow-purple">
        <h3
        ...
        <p className="text-[#f0ece4]/80 leading-relaxed mb-6">
        ...
        <p className="text-[#f0ece4]/80 leading-relaxed mb-8">
      ...
      <div className="text-center mb-20 space-y-3">
        ...
        <p className="text-[#9c98a8] mt-8 text-lg italic">
      ...
      {/* Welcome */}
      <div className="text-center rounded-2xl p-8 bg-[#13101c] border border-[#f5a623]/20 mb-20">
        <p className="text-[#f0ece4] text-lg leading-relaxed">
      ...
      <div className="bg-[#13101c]/60 rounded-2xl p-8 border border-[#7b5ea7]/20 mb-12">
        <p className="text-[#9c98a8] text-center italic mb-4">
          Lozen&apos;s personal story is coming soon.
        </p>
        <p className="text-[#f0ece4]/70 text-center text-sm">
      ...
      <div className="flex items-start gap-6">
        <div className="shrink-0 w-16 h-16 rounded-full bg-gradient-to-br from-[#f5a623] to-[#7b5ea7] flex items-center justify-center text-[#0d0b12] font-bold text-sm">
          2018
        </div>
        <div>
          <h4
